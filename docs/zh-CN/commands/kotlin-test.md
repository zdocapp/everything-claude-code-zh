---
description: 为Kotlin强制执行TDD工作流程。首先编写Kotest测试，然后实现。使用Kover验证80%以上的覆盖率。
---
...
````text
User: /kotlin-test 我需要一个函数来验证用户注册请求

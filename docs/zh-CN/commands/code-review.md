...
如果没有更改的文件，则停止："Nothing to review."
...
**完整**阅读每个更改的文件（不仅仅是差异块 — 需要周围的上下文）。

对于 PR 审查，获取 PR 头部修订版本的完整文件内容：
...
产物:
  评审: .claude/PRPs/reviews/pr-<编号>-review.md
  GitHub: <PR URL>

...
* 氛围：优雅、高端、富有氛围感
* 最佳用途：奢侈品牌、深思熟虑的叙述、高端产品演示
* 字体：Cormorant + IBM Plex Sans
* 调色板：近黑色、暖象牙色、腮红、金色、赤陶色
...
* 调色板：炭黑背景上的奶油色纸张，搭配柔和色彩的标签
* 特色：纸张效果、彩色侧边标签、活页夹细节

### 6. Pastel Geometry

* 氛围：平易近人、现代、友好
* 最佳用途：产品概述、入门指南、较轻松的品牌演示
...
* 最佳用途：机构介绍、研讨会、作品集
* 字体：仅使用 Outfit
* 调色板：桃色 + 薰衣草色分割背景，搭配薄荷色徽章
* 特色：分割背景、圆角标签、轻量网格叠加

### 8. Vintage Editorial

* 氛围：诙谐、个性鲜明、受杂志启发
* 最佳用途：个人品牌、观点鲜明的演讲、故事讲述
* 字体：Fraunces + Work Sans
* 调色板：奶油色、炭黑色、灰蒙蒙的暖色调点缀
* 特色：几何点缀、带边框的标注、醒目的衬线标题

### 9. Neon Cyber

* 氛围：未来感、科技感、动感
* 最佳用途：人工智能、基础设施、开发工具、关于未来趋势的演讲
* 字体：Clash Display + Satoshi
* 调色板：午夜海军蓝、青色、品红色
* 特色：发光效果、粒子、网格、数据雷达般的能量感

### 10. Terminal Green

* 氛围：面向开发者、黑客风格简洁
* 最佳用途：API、CLI 工具、工程演示
* 字体：仅使用 JetBrains Mono
* 调色板：GitHub 深色主题 + 终端绿色
...
如果用户已经知道自己想要的样式，让他们直接从上面的预设名称中选择，而不是强制生成预览。
...
| 科技感 / 未来感 | 发光、粒子、网格运动、文字打乱重组 |
| 有趣 / 友好 | 弹性缓动、圆润形状、浮动效果 |
| 专业 / 企业 | 微妙的 200-300 毫秒过渡、简洁的幻灯片切换 |
| 平静 / 极简 | 非常克制的运动、优先考虑留白 |
| 编辑感 / 杂志感 | 强烈的层次感、文本和图像交错的错落效果 |
...
* 白底紫字的创业公司模板
* 将 Inter / Roboto / Arial 作为视觉主字体，除非用户明确想要实用主义的中性风格
* 要点墙、过小的字体或需要滚动的代码块
* 装饰性插图，而抽象几何图形能更好地完成工作

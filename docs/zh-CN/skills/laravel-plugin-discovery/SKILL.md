...
* 用户想要查找特定功能（例如“auth”、“permissions”、“admin panel”）的 Laravel 包
* 用户询问“我应该使用什么包来...”或“有没有 Laravel 包可以...”
* 用户想要检查一个包是否被积极维护
...
必须配置 LaraPlugins MCP 服务器。将其添加到你的 `~/.claude.json` mcpServers 中：

...
description: Remotion 最佳实践 - 在 React 中创建视频。涵盖 3D、动画、音频、字幕、图表、过渡等领域的 29 条特定规则。
metadata:
...
每当处理 Remotion 代码以获取领域特定知识时，请使用此技能。
...
* [rules/audio.md](rules/audio.md) - 在 Remotion 中使用音频和声音 - 导入、修剪、音量、速度、音高
...
* [rules/extract-frames.md](rules/extract-frames.md) - 使用 Mediabunny 从视频的特定时间戳提取帧
...
* [rules/sequencing.md](rules/sequencing.md) - Remotion 的序列模式 - 延迟、修剪、限制项目时长
...
* [rules/videos.md](rules/videos.md) - 在 Remotion 中嵌入视频 - 修剪、音量、速度、循环、音高
